...
// 追加ボタン・変更ボタンの共通の土台(issue #277)。見た目は仕様(apps/web の
// `src/data/uiButton.ts`。説明は `/ui?item=part-button`)を tokens.css の CSS 変数
// だけで写したもの(App.css の `.action-button*`)で、ここには値を持たない。
// 画面から直接使わず、AddButton / EditButton を使う。どちらもアイコンは付けず、
// 文字だけのラベルで構成する。
...
type ActionButtonKind = "add" | "edit";

...
// ビューアのサイドメニュー下部の「設定」(プロファイル設定。issue #299)。歯車。
// Material Icons の「Settings」(MUI の `@mui/icons-material` `Settings` のパスを
// そのまま使う。MIT ライセンス)。塗りつぶしの図形で viewBox は 24×24 のまま。
export const PROFILE_SETTINGS_ICON = `

...
export const WBS_SOURCE = {
  ...
  wbs: [
    ...
    { _id: 13, _class: "WBS", name: "YAOYOROZU" },
    { _id: 14, _class: "WBS", name: "claude" },
    { _id: 15, _class: "WBS", name: "claude code" },
    { _id: 16, _class: "WBS", name: "claude code app" },
    { _id: 20, _class: "WBS", name: "画面" },
    { _id: 21, _class: "WBS", name: "WBS" },
    { _id: 22, _class: "WBS", name: "構成図" },
    { _id: 23, _class: "WBS", name: "UIデザイン" },
    { _id: 24, _class: "WBS", name: "サイトマップ" },
    { _id: 25, _class: "WBS", name: "Classes" },
    { _id: 26, _class: "WBS", name: "TM" },
  ...
  edges: [
    ...
    { from_id: 10, from_class: "WBS", to_id: 13, to_class: "WBS" },
    { from_id: 10, from_class: "WBS", to_id: 14, to_class: "WBS" },
    { from_id: 13, from_class: "WBS", to_id: 12, to_class: "WBS" },
    { from_id: 13, from_class: "WBS", to_id: 11, to_class: "WBS" },
    { from_id: 14, from_class: "WBS", to_id: 15, to_class: "WBS" },
    { from_id: 15, from_class: "WBS", to_id: 16, to_class: "WBS" },
    { from_id: 20, from_class: "WBS", to_id: 21, to_class: "WBS" },
    { from_id: 20, from_class: "WBS", to_id: 22, to_class: "WBS" },
    { from_id: 20, from_class: "WBS", to_id: 23, to_class: "WBS" },
    { from_id: 20, from_class: "WBS", to_id: 24, to_class: "WBS" },
    { from_id: 20, from_class: "WBS", to_id: 25, to_class: "WBS" },
    { from_id: 20, from_class: "WBS", to_id: 26, to_class: "WBS" },
    ...
    { from_id: 65, from_class: "WBS", to_id: 62, to_class: "WBS" },
    { from_id: 65, from_class: "WBS", to_id: 64, to_class: "WBS" },
